...
import group.aitools.nhs.demo.domain.bo.TestTreeBo;
import group.aitools.nhs.demo.domain.vo.TestTreeVo;
import group.aitools.nhs.demo.mapper.TestTreeMapper;
import group.aitools.nhs.demo.service.ITestTreeService;
...
// @DS("slave") // 切换从库查询
/**
 * 负责{@code TestTree}相关的业务编排与领域规则处理。
 */
