...
import group.aitools.nhs.common.mcp.core.McpClientTemplate;
import group.aitools.nhs.common.mcp.core.McpResourceReadResult;
import group.aitools.nhs.common.mcp.core.McpToolCallResult;
 ...
 * <p>
 * 如果要用当前项目自己连自己测试，建议启动两个 `nhs-admin` 实例：
