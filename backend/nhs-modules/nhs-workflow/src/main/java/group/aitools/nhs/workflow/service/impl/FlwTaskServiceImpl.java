package group.aitools.nhs.workflow.service.impl;
...
import group.aitools.nhs.common.liteflow.utils.LiteFlowUtils;
...
import group.aitools.nhs.workflow.api.domain.StartProcessReturnDTO;
import group.aitools.nhs.workflow.common.ConditionalOnEnable;
import group.aitools.nhs.workflow.common.enums.TaskAssigneeType;
import group.aitools.nhs.workflow.common.enums.TaskStatusEnum;
import group.aitools.nhs.workflow.domain.bo.*;
...
import group.aitools.nhs.workflow.domain.vo.FlowCopyVo;
import group.aitools.nhs.workflow.domain.vo.FlowHisTaskVo;
import group.aitools.nhs.workflow.domain.vo.FlowTaskVo;
import group.aitools.nhs.workflow.domain.vo.NodeExtVo;
import group.aitools.nhs.workflow.mapper.FlwCategoryMapper;
import group.aitools.nhs.workflow.mapper.FlwHisTaskMapper;
import group.aitools.nhs.workflow.mapper.FlwTaskMapper;
import group.aitools.nhs.workflow.service.IFlwCommonService;
import group.aitools.nhs.workflow.service.IFlwNodeExtService;
import group.aitools.nhs.workflow.service.IFlwTaskAssigneeService;
...
public class FlwTaskServiceImpl implements IFlwTaskService {
    ...
    public void setCopy(Task task, List<FlowCopyBo> flowCopyList) {
        ...
        flwCommonService.sendMessage(
            List.of(group.aitools.nhs.workflow.common.enums.MessageTypeEnum.SYSTEM_MESSAGE.getCode()),
            "您收到一条新的流程抄送，请及时查看。",
            "单据抄送提醒",
    ...
    /**
     * 获取{@code PreviousNodeMap}。
     *
     * @param nodeCode {@code nodeCode}参数
     * @param flowCombine {@code flowCombine}参数
     * @return 处理结果
     */
    ...
    /**
     * 处理{@code collectReachableNodeCodes}相关逻辑。
     *
     * @param nodeCodes {@code nodeCodes}参数
