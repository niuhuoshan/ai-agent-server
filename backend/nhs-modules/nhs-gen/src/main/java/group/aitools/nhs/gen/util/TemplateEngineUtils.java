package group.aitools.nhs.gen.util;
...
import group.aitools.nhs.common.mybatis.enums.DataBaseType;
import group.aitools.nhs.common.mybatis.helper.DataBaseHelper;
import group.aitools.nhs.gen.constant.GenConstants;
import group.aitools.nhs.gen.domain.GenTable;
import group.aitools.nhs.gen.domain.GenTableColumn;
import group.aitools.nhs.gen.util.template.PathNamedTemplate;
...
public class TemplateEngineUtils {
     ...
     * 判断DateRange查询是否满足要求。
     *
     * @param genTable {@code genTable}参数
    ...
    /**
     * 获取FrontendPage模板PathPattern。
     *
     * @param frontendType 业务类型
     * @param templatePrefix 模板Prefix参数
     * @return 处理结果
     */
