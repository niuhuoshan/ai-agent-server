package group.aitools.nhs.common.oss.client;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.IdUtil;
import group.aitools.nhs.common.core.utils.DateUtils;
import group.aitools.nhs.common.core.utils.StringUtils;
import group.aitools.nhs.common.oss.config.OssClientConfig;
import group.aitools.nhs.common.oss.exception.S3StorageException;
import group.aitools.nhs.common.oss.io.OutputStreamDownloadSubscriber;
import group.aitools.nhs.common.oss.model.GetObjectResult;
import group.aitools.nhs.common.oss.model.HandleAsyncResult;
...
public abstract class AbstractOssClientImpl implements OssClient {
    ...
    public PutObjectResult bucketUpload(String bucket, String key, InputStream in, long contentLength, Options options) {
        Path tempFile = null;
        try {
            tempFile = Files.createTempFile("nhs-oss-upload-", ".tmp");
