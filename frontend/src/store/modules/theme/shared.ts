...
export function getNaiveTheme(
  ...
  const surfaceRadius = `${Math.min(Math.max(settings.themeRadius + 2, 8), 10)}px`;
  const primaryTint = (alpha: number) => addColorAlpha(colors.primary, alpha);
  ...
  const theme: GlobalThemeOverrides = {
    ...
    DataTable: {
      ...
      thColor: primaryTint(0.045),
      thColorHover: primaryTint(0.08),
      tdColorHover: primaryTint(0.055),
      thFontWeight: '650',
      thPaddingSmall: '10px 14px',
      thPaddingMedium: '13px 16px',
      thPaddingLarge: '16px 18px',
      tdPaddingSmall: '10px 14px',
      tdPaddingMedium: '14px 16px',
      tdPaddingLarge: '16px 18px',
      paginationMargin: '16px 16px 14px'
    },
    Pagination: {
      itemBorderRadius: `${Math.max(settings.themeRadius, 6)}px`,
      itemColorActive: primaryTint(0.12),
      itemColorActiveHover: primaryTint(0.18),
      itemTextColorActive: colors.primary,
      itemBorderActive: `1px solid ${primaryTint(0.18)}`,
      itemBorderActiveHover: `1px solid ${primaryTint(0.28)}`,
      itemSizeMedium: '30px',
      itemPaddingMedium: '0 9px',
      itemMarginMedium: '0 3px'
    },
    Tabs: {
      tabFontWeight: '500',
      tabFontWeightActive: '650',
      tabGapMediumLine: '24px',
      tabPaddingMediumLine: '12px 4px 13px',
      tabBorderRadius: surfaceRadius,
      barColor: colors.primary,
      colorSegment: primaryTint(0.07),
      tabColorSegment: 'transparent',
      tabColor: 'var(--n-color)'
    }
  };
