...
import { getGlobalMenuGroups, type GlobalMenuGroup } from './menu-groups';
...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
  ...
  const menuGroups = computed<GlobalMenuGroup[]>(() => getGlobalMenuGroups(menus.value));
  ...
  async function initAuthRoute() {
    ...
    // Session restoration may clear an expired token and rebuild constant routes.
    // Do not request or install protected routes after that reset has completed.
