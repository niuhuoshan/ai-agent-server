const local: App.I18n.Schema = {
  ...
  route: {
    ...
    home: 'Home',
    workspace: 'Workspace',
    'task-center': 'Task Operations',
    'project-center': 'Project Operations',
    ...
    chatbi: 'ChatBI Workbench',
    'prompt-studio': 'Prompt Studio',
    'personal-center': 'Personal Center',
    'scenario-templates': 'Scenario Templates',
    'slash-commands': 'Slash Commands',
    memory: 'Personal Memory',
    examples: 'ChatBI Examples',
    'resource-center': 'Resource Configuration',
    system: 'System',
    'token-stats': 'Token Statistics',
    'open-api': 'Open API',
    'widget-debugger': 'Widget Debugger'
  },
  menuGroup: {
  ...
  page: {
    ...
    taskCenter: {
      title: 'Task Center',
      desc: 'Manage and monitor all task executions',
      createTask: 'Create Task'
    },
    agentCenter: {
      title: 'Agent Center',
      desc: 'Manage and configure agents'
    },
    automation: {
      title: 'Automation',
      desc: 'Trigger fixed-version tasks manually, on a schedule, or by webhook'
    },
    knowledge: {
      title: 'Knowledge Base',
      desc: 'Manage knowledge bases and documents'
    },
    dataSource: {
      title: 'Data Source',
      desc: 'Configure and manage data source connections'
    },
    riskControl: {
      title: 'Risk Control',
      desc: 'Approval management and risk policy configuration'
    },
    system: {
      title: 'System Management',
      desc: 'Members, roles and permissions management'
    },
    openApi: {
      title: 'Open API',
      desc: 'API applications and webhook configuration'
    }
  },
  form: {
